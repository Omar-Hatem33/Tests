...
# ── PostgreSQL ──
export SPRING_DATASOURCE_URL=jdbc:postgresql://localhost:5432/uberdb
export SPRING_DATASOURCE_USERNAME=postgres
export SPRING_DATASOURCE_PASSWORD=postgres

# ── MongoDB ──
export SPRING_DATA_MONGODB_URI=mongodb://root:rootpass@localhost:27017/ubermongo?authSource=admin
...
export SPRING_CASSANDRA_KEYSPACE_NAME=uberks
...
- `src/test/java/com/testgen/uber/` — the test files (PublicTests, DP_PatternTests, TestBase, TestAuthHelper)
- `src/test/resources/manifest.json` — your project's discovered structure
- `src/test/resources/theme.json` — Uber spec constants
